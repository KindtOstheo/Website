  ...
  - list:
      - speciality_draft: true
        ...
        description: |
          ...
          ### Dès cette époque une controverse s'ouvre non encore résolue aujourd'hui. Les articulations des os du crâne que l'on appelle [sutures crâniennes](https://kinedoc.org/work/kinedoc/4c9c284e-37c1-4dc7-b16c-a91e5eb8bb40.pdf "Sutures crâniennes"), sont des articulations dites immobiles. Mais, ces os conservent-ils leur indépendance pour autant, sont-ils libres, entre-eux ?
      ...
      - speciality_draft: true
        ...
        description: |
          ...
          ### Notre cerveau baigne dans 150 ml d'un liquide appelé [liquide cérébrospinal](https://www.pourlascience.fr/sd/neurosciences/liquide-cephalorachidien-vingt-mille-lieues-sous-un-crane-22396.php#:~\:text=Notre%20cerveau%20n'est%20pas,dit%20%C2%AB%20sous%2Darachno%C3%AFdien%20%C2%BB. "LCR"). Ce liquide peut atteindre suivant les endroits de l'encéphale une vitesse de 10 cm par seconde, les auteurs parlent de "[Maelstrom](https://www.google.com/search?q=maelstrom+def\&oq=\&gs_lcrp=EgZjaHJvbWUqBggCEEUYOzIMCAAQRRg5GLEDGIAEMgYIARBFGEAyBggCEEUYOzIMCAMQABhDGIAEGIoFMgwIBBAAGEMYgAQYigUyDAgFEAAYQxiABBiKBTIHCAYQABiABDIHCAcQABiABNIBCDkwOTZqMGo3qAIAsAIA\&sourceid=chrome\&ie=UTF-8 "Maelstrom")".
      ...
      - speciality_draft: true
        ...
        description: |
          ...
          ### L'[ontogenèse](https://fr.wikipedia.org/wiki/Ontogen%C3%A8se#:~\:text=L'ontogen%C3%A8se%20\(ou%20ontog%C3%A9nie\),voire%20jusqu'%C3%A0%20sa%20mort. "ontogenèse") a progressivement fait évoluer leurs spécificités ; mais les os crâniens comme les vertèbres entourent et protègent le système nerveux central.
      ...
      - speciality_draft: false
        ...
        description: |
          ### Le sphénoïde est l'os situé au centre du crâne. Quand on le regarde, on est plus près d'un tableau de Picasso que d'un Botticelli. La morphologie est éclatée, chaotique, les lignes sont brisées ; même après des heures d'étude, ce capharnaüm de formes,  reste difficile à mémoriser.

          ### Les rapports avec ses os satellites sont loin d'être classiques et continuent encore aujourd'hui d'être des hypothèses de pensée.
