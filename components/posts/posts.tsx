      ...
      {data.map((postData) => {
        ...
        return (
          <Link
            ...
            style={Styles.color}
            className={` category ${post.category.name} shadow-[0_10px_35px_rgba(0,0,0,.05)] md:w-9/12 group block px-6 sm:px-8 md:px-10 py-10 mb-8 last:mb-0 rounded-md transition-all duration-150 ease-out hover:shadow-md`}
          >
