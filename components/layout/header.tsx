                  ...
                  {data.nav &&
                    ...
                    >
                      <Link
                        ...
                        href={`/${item.href}`}
                        className={`relative select-none	text-xl inline-block tracking-wide transition duration-150 ease-out hover:text-[#9e6851] hover: py-8 px-4 ${
                    ...
                    >
                      <Link
                        ...
                        className={`relative select-none	text-xl inline-block tracking-wide transition duration-150 ease-out  hover:bg-[#916d5ebd] hover:text-white py-8 px-4 ${
